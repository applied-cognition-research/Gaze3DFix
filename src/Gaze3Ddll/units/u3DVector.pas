unit u3DVector;
{
  ...
  ===========
    ...
    Support unit for vector calculation
}
...
type TVector = record
     ...
     function vNormCrossProduct (s1,s2,n: TVector): Double;
...
begin
  ...
  try
    ...
    u := -vNormCrossProduct(SVg,SVh,nE2) / vScalarProduct(DVg,nE2);   // foot of a dropped perpendicular at g
    v :=  vNormCrossProduct(SVg,SVh,nE1) / vScalarProduct(DVh,nE1);   // foot of a dropped perpendicular at h
